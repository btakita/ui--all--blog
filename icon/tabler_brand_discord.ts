...
export function tabler_brand_discord_($p?:{ class?:string }) {
	return (
		svg_({
			...
			circle_({ cx: 9, cy: 12, r: 1 }),
			circle_({ cx: 15, cy: 12, r: 1 }),
			path_({ d: 'M7.5 7.5c3.5 -1 5.5 -1 9 0' }),
			path_({ d: 'M7 16.5c3.5 1 6.5 1 10 0' }),
			path_({
